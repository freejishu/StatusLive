...
<html class="full-height">
    ...
    <body>
        ...
        <script>
        //喜闻乐见的配置
        var config_title = "状态监控",
            config_title_english = "StatusLive",
            config_warning_flash = false,
            config_status_key = "KQLq0Cy2M";
            config_ajax_mode = 1;
            config_ajax_proxy_domain = "";
            config_show_chart = false;
            config_auto_refresh_seconds = 60;
            //config[title][english] = "LiveStatus";
